...
class SquirrelWindowsTarget extends (_electronBuilder || _load_electronBuilder()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const installerOutDir = _path.join(_this.outDir, `squirrel-windows${(0, (_electronBuilder || _load_electronBuilder()).getArchSuffix)(arch)}`);
            ...
            packager.dispatchArtifactCreated(_path.join(installerOutDir, setupFile), _this, arch, `${sanitizedName}-Setup-${version}${(0, (_electronBuilder || _load_electronBuilder()).getArchSuffix)(arch)}.exe`);
